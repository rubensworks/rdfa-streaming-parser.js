...
<body prefix="schema: http://schema.org/">
    <h2 about="#myDoc" typeof="schema:Document">The Trouble with Bob</h2>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#myDoc', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Document'),
          ]);
      });
...
<body vocab="http://schema.org/">
    <h2 about="#myDoc" typeof="">The Trouble with Bob</h2>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
          ]);
      });
...
<body prefix="schema: http://schema.org/">
    <h2 about="#myDoc" typeof="schema:Document1 schema:Document2">The Trouble with Bob</h2>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#myDoc', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Document1'),
            quad('http://example.org/#myDoc', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Document2'),
          ]);
      });
...
<body prefix="schema: http://schema.org/">
    <h2 about="#myDoc1" resource="#myDoc2" typeof="schema:Document">The Trouble with Bob</h2>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#myDoc1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Document'),
          ]);
      });
...
<body prefix="schema: http://schema.org/">
    <h2 typeof="schema:Document">The Trouble with Bob</h2>
          ...
          .toBeRdfIsomorphic([
            quad('_:b', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Document'),
          ]);
      });
    ...
    <p>
      ...
      <a about="photo1.jpg" rel="dc:creator" rev="foaf:img"
          ...
          .toBeRdfIsomorphic([
            ...
            quad('http://www.blogger.com/profile/1109404', 'http://xmlns.com/foaf/0.1/img', 'http://example.org/photo1.jpg'),
          ]);
      });
...
<body>
  <div about="http://example.org/foaf#me" property="foaf:name">
    ...
    <span property="foaf:familyName">Doe</span>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/familyName', '"Doe"'),
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/givenName', '"John"'),
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/name', '"\n    John\n    Doe\n  "'),
          ]);
      });
...
<body>
  <div about="http://example.org/foaf#me" property="foaf:name"><span property="foaf:givenName">John</span> <span property="foaf:familyName">Doe</span></div>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/familyName', '"Doe"'),
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/givenName', '"John"'),
            quad('http://example.org/foaf#me', 'http://xmlns.com/foaf/0.1/name', '"John Doe"'),
          ]);
  ...
  <body>
    <p property="dc:title" datatype="rdf:XMLLiteral"><b property="foaf:firstName">Mark</b></p>
          ...
          .toBeRdfIsomorphic([
            ...
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/firstName', '"Mark"'),
          ]);
      });
  ...
  <body>
    <p property="dc:title foaf:title">Title</p>
          ...
          .toBeRdfIsomorphic([
            ...
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/title', '"Title"'),
          ]);
      });
    ...
    <p>
      ...
      <span rel="dc:creator">
          ...
          .toBeRdfIsomorphic([
            ...
            quad('_:b', 'http://xmlns.com/foaf/0.1/name', '"Ben Adida"'),
          ]);
      });
  ...
  <body>
    <p>
      ...
      <span rel="dc:creator dc:creator2">
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://purl.org/dc/elements/1.1/creator', '_:b'),
            quad('http://example.org/', 'http://purl.org/dc/elements/1.1/creator2', '_:b'),
            quad('_:b', 'http://xmlns.com/foaf/0.1/name', '"Ben Adida"'),
          ]);
      });
...
<body>
  <p vocab="http://schema.org/">
    The homepage of <a href="http://homepage.org/" property="homepage" rel="nofollow">Some Body</a>.
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://example.org/', 'http://schema.org/homepage', 'http://homepage.org/'),
          ]);
      });
...
<body>
  <p vocab="http://schema.org/">
    The homepage of <a href="http://homepage.org/" property="homepage" rel="follow">Some Body</a>.
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://example.org/', 'http://schema.org/homepage', '"Some Body"'),
            quad('http://example.org/', 'http://schema.org/follow', 'http://homepage.org/'),
          ]);
      });
...
<body>
  <p vocab="http://schema.org/">
    The homepage of <a href="http://homepage.org/" property="homepage" rel="http://example.org/follow">Some Body</a>.
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://example.org/', 'http://example.org/follow', 'http://homepage.org/'),
            quad('http://example.org/', 'http://schema.org/homepage', '"Some Body"'),
          ]);
      });
...
<body>
  <p vocab="http://schema.org/">
    The homepage of <a href="http://homepage.org/" property="homepage" rev="schema:followedBy">Some Body</a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://homepage.org/', 'http://schema.org/followedBy', 'http://example.org/'),
            quad('http://example.org/', 'http://schema.org/homepage', '"Some Body"'),
          ]);
      });
...
<body>
  <p vocab="http://schema.org/">
    The homepage of <a href="http://homepage.org/" property="homepage" rev="http://example.org/followedBy">Some Body</a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://homepage.org/', 'http://example.org/followedBy', 'http://example.org/'),
            quad('http://example.org/', 'http://schema.org/homepage', '"Some Body"'),
          ]);
      });
...
<body vocab="http://schema.org/">
  ...
  <div about="http://www.example.org/#somebody" rel="foaf:knows">
      <p typeof="foaf:Person">Dan Brickley again:-)</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b1'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
          ]);
      });
  ...
  <p property="foaf:name">Dan Brickley?</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b1'),
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b2'),
            quad('_:b1', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley"'),
            quad('_:b2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley?"'),
          ]);
      });
  ...
  <p about="[_:]" property="foaf:name">Dan Brickley?</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b1'),
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b2'),
            quad('_:b2', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley"'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
            quad('_:b1', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley?"'),
          ]);
      });
  ...
  <p about="[_:]" property="foaf:name">Dan Brickley?</p>
          ...
          .toBeRdfIsomorphic([
            ...
            quad('_:b2', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley"'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
            quad('_:b3', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley?"'),
          ]);
      });
  ...
  <p about="[_:]" property="foaf:name">Dan Brickley?</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/#somebody', 'http://xmlns.com/foaf/0.1/knows', '_:b1'),
            quad('_:b1', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley"'),
            quad('_:b1', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley again:-)"'),
            quad('_:b3', 'http://xmlns.com/foaf/0.1/name', '"Dan Brickley?"'),
          ]);
      });
  ...
  <div>
    <div resource="#muse" typeof="rdfa:Pattern">
      ...
      <span property="schema:name">Muse</span>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#muse', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://www.w3.org/ns/rdfa#Pattern'),
            quad('http://example.org/#muse', 'http://schema.org/image', 'http://example.org/Muse1.jpg'),
            quad('http://example.org/#muse', 'http://schema.org/image', 'http://example.org/Muse2.jpg'),
            quad('http://example.org/#muse', 'http://schema.org/image', 'http://example.org/Muse3.jpg'),
            quad('http://example.org/#muse', 'http://schema.org/name', '"Muse"'),
          ]);
  ...
  <div>
    ...
    <p typeof="schema:MusicEvent">
      ...
      <a property="schema:location" href="#united">United Center, Chicago, Illinois</a>
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/MusicEvent'),
            quad('_:b1', 'http://schema.org/image', 'http://example.org/Muse1.jpg'),
            quad('_:b1', 'http://schema.org/image', 'http://example.org/Muse2.jpg'),
            quad('_:b1', 'http://schema.org/image', 'http://example.org/Muse3.jpg'),
            quad('_:b1', 'http://schema.org/name', '"Muse"'),
            quad('_:b1', 'http://schema.org/location', 'http://example.org/#united'),
          ]);
      });
  ...
  <body>
    <p typeof="schema:MusicEvent">
      ...
      <a property="schema:location" href="#united">United Center, Chicago, Illinois</a>
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/MusicEvent'),
            quad('_:b1', 'http://www.w3.org/ns/rdfa#copy', 'http://example.org/#muse'),
            quad('_:b1', 'http://schema.org/location', 'http://example.org/#united'),
          ]);
      });
    ...
    <p typeof="schema:MusicEvent">
      ...
      <a property="schema:location" href="#united2">United Center, Chicago, Illinois 2</a>
          ...
          .toBeRdfIsomorphic([
            ...
            quad('_:b2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/MusicEvent'),
            quad('_:b2', 'http://schema.org/image', 'http://example.org/Muse1.jpg'),
            quad('_:b2', 'http://schema.org/image', 'http://example.org/Muse2.jpg'),
            quad('_:b2', 'http://schema.org/image', 'http://example.org/Muse3.jpg'),
            quad('_:b2', 'http://schema.org/name', '"Muse"'),
            quad('_:b2', 'http://schema.org/location', 'http://example.org/#united2'),
          ]);
      });
  ...
  <div>
    ...
    <p typeof="schema:MusicEvent">
      <link property="rdfa:copy" href="#muse"/>
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/MusicEvent'),
            quad('_:b1', 'http://schema.org/refers-to', '_:b_shared'),
            quad('_:b_shared', 'http://schema.org/name', '"Muse"'),

            quad('_:b2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/MusicEvent'),
            quad('_:b2', 'http://schema.org/refers-to', '_:b_shared'),
          ]);
      });
...
<body vocab="http://schema.org/">
  ...
  <p resource="_:a" typeof="rdfa:Pattern">Name: <span property="name">Amanda</span></p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Person'),
            quad('_:b1', 'http://schema.org/name', '"Amanda"'),
          ]);
      });
...
<body vocab="http://schema.org/">
  ...
  <p resource="_:a" typeof="rdfa:Pattern">Name: <span property="name">Amanda</span></p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://schema.org/Person'),
            quad('_:b1', 'http://www.w3.org/ns/rdfa#copy', '_:b2'),
            quad('_:b2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://www.w3.org/ns/rdfa#Pattern'),
            quad('_:b2', 'http://schema.org/name', '"Amanda"'),
          ]);
      });
  ...
  <body>
    <p about="" typeof="foaf:Document" property="foaf:topic">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            ...
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', '"John Doe"'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" resource="http://example.org/res">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/res', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'http://example.org/res'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" resource="foaf:res">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://xmlns.com/foaf/0.1/res', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'http://xmlns.com/foaf/0.1/res'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" href="http://example.org/href">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/href', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'http://example.org/href'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" href="foaf:href">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('foaf:href', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'foaf:href'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" src="http://example.org/src">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/src', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'http://example.org/src'),
          ]);
      });
  ...
  <body>
    <p typeof="foaf:Document" property="foaf:topic" src="foaf:src">John Doe</p>
          ...
          .toBeRdfIsomorphic([
            quad('foaf:src', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/topic', 'foaf:src'),
          ]);
      });
...
property="foaf:name" typeof="foaf:Document">
  ...
  <body>
    <p prefix="bibo: http://purl.org/ontology/bibo/ dc: http://purl.org/dc/terms/" typeof="bibo:Chapter">
      ...
      <a inlist="" property="dc:creator"
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://purl.org/ontology/bibo/Chapter'),
            quad('_:b1', 'http://purl.org/dc/terms/creator', '_:b_l1'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://ben.adida.net/#me'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l2'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://twitter.com/markbirbeck'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l3'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://www.ivan-herman.net/foaf#me'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
      });
    ...
    <p prefix="bibo: http://purl.org/ontology/bibo/ dc: http://purl.org/dc/terms/" typeof="bibo:Chapter">
      ...
      <a inlist="" property="dc:creator"
          ...
          .toBeRdfIsomorphic([
            ...
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://ben.adida.net/#me'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l2'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"Mark Birbeck"'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l3'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://www.ivan-herman.net/foaf#me'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
    ...
    <p prefix="bibo: http://purl.org/ontology/bibo/ dc: http://purl.org/dc/terms/" typeof="bibo:Chapter">
      ...
      <a inlist="" property="dc:creator"
          ...
          .toBeRdfIsomorphic([
            ...
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://ben.adida.net/#me'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l2'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"2018"^^http://www.w3.org/2001/XMLSchema#gYear'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l3'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://www.ivan-herman.net/foaf#me'),
            quad('_:b_l3', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
  ...
  <body>
    <p prefix="bibo: http://purl.org/ontology/bibo/ dc: http://purl.org/dc/terms/" typeof="bibo:Chapter">
      <span rel="dc:creator" inlist=""></span>
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://purl.org/ontology/bibo/Chapter'),
            quad('_:b1', 'http://purl.org/dc/terms/creator', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
      });
    ...
    <div about="">
      <ol rel="rdf:value" inlist="">
        ...
        <li><a href="bar">Bar</a></li>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '_:b_l1'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://example.org/foo'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', '_:b_l2'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', 'http://example.org/bar'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
      });
  ...
  <body>
    <p about="res" property="rdf:value" inlist="">Bar</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/res', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '_:b_l1'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"Bar"'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
      });
  ...
  <body>
    ...
    <p about="res" property="rdf:value" inlist="">Foo</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/res', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '_:b_l1'),
            quad('http://example.org/res', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '_:b_l2'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"Bar"'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"Foo"'),
            quad('_:b_l2', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
      });
...
<body prefix="ex: http://www.example.org/">
  <span property="ex:inlist" resource="res">
    <p property="rdf:value" inlist="">Bar</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.example.org/inlist', 'http://example.org/res'),
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '_:b_l1'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first', '"Bar"'),
            quad('_:b_l1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil'),
          ]);
  ...
  <span rel="ex:inlist" resource="res">
   ...
   <body>
      <p>This is the first chapter in a series of chapters.</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://example.org/next', 'http://rdfa.info/test-suite/test-cases/rdfa1.1/xhtml1/0062.xhtml'),
          ]);
      });
   ...
   <body>
      <p>This is the first chapter in a series of chapters.</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'ex:next', 'http://rdfa.info/test-suite/test-cases/rdfa1.1/xhtml1/0062.xhtml'),
          ]);
      });
...
<body>
  <div about="[]" property="foaf:name">Alex Milowski</div>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/name', '"Alex Milowski"'),
          ]);
      });
...
<body>
  <div about="[]" typeof="foaf:Person" property="foaf:name">Alex Milowski</div>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/name', '"Alex Milowski"'),
            quad('_:b', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
          ]);
      });
...
<body>
  <div about="[]" property="foaf:name"><p property="foaf:firstName">Alex</p> Milowski</div>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/name', '"Alex Milowski"'),
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/firstName', '"Alex"'),
          ]);
      });
...
<body>
  <div typeof="foaf:Person">
    <span property="foaf:name">Alex Milowski</span>
          ...
          .toBeRdfIsomorphic([
            quad('_:b1', 'http://xmlns.com/foaf/0.1/name', '"Alex Milowski"'),
            quad('_:b1', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
          ]);
      });
...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body typeof="foaf:Document" property="foaf:name">
      <p>This is test #66.</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://xmlns.com/foaf/0.1/name', '_:b'),
            quad('_:b', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Document'),
          ]);
      });
...
<body>
  <p property="dc:language" datatype="pred/lang">JavaScript</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/me', 'http://purl.org/dc/terms/language', '"JavaScript"'),
          ]);
      });
...
<body>
  ...
  <p about="http://example.org/" property="rdf:value" datatype="">value</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '"value"'),
          ]);
      });
...
<body>
  ...
  <p about="http://example.org/" property="rdf:value" datatype="">value <em>bar</em></p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '"value bar"'),
          ]);
      });
...
<body>
  ...
  <div datatype="rdf:HTML" property="schema:description">
    <a href="http://example.org/" property="rdf:value" datatype="">value <em>bar</em></a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '"value bar"'),
            quad('http://example.org/', 'http://schema.org/description', '"\n    <a href="http://example.org/" property="rdf:value" datatype="">value <em>bar</em></a>\n  "^^http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML'),
          ]);
      });
...
<body>
  ...
  <div datatype="rdf:HTML" property="schema:description">
    <a href="http://example.org/" property="rdf:value" datatype="">value <em>bar</em><div datatype="rdf:HTML" property="schema:description2"><a href="http://example.org/" property="rdf:value2" datatype="">value2 <em>bar2</em></a></div></a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value2', '"value2 bar2"'),
            quad('http://example.org/', 'http://schema.org/description2', '"<a href="http://example.org/" property="rdf:value2" datatype="">value2 <em>bar2</em></a>"^^http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML'),
            quad('http://example.org/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '"value barvalue2 bar2"'),
            quad('http://example.org/', 'http://schema.org/description', '"\n    <a href="http://example.org/" property="rdf:value" datatype="">value <em>bar</em><div datatype="rdf:HTML" property="schema:description2"><a href="http://example.org/" property="rdf:value2" datatype="">value2 <em>bar2</em></a></div></a>\n  "^^http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML'),
          ]);
      });
...
<body>
  <div vocab="http://xmlns.com/foaf/0.1/" resource="http://example.com/gregg/#me" typeof="Person">
    <a property="homepage" href="http://example.com/gregg/"><span property="name">Gregg</span></a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://xmlns.com/foaf/0.1/'),
            quad('http://example.com/gregg/#me', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
            quad('http://example.com/gregg/#me', 'http://xmlns.com/foaf/0.1/homepage', 'http://example.com/gregg/'),
            quad('http://example.com/gregg/#me', 'http://xmlns.com/foaf/0.1/name', '"Gregg"'),
          ]);
      });
...
<body>
  <div vocab="http://xmlns.com/foaf/0.1/" resource="http://example.com/gregg/#me">
    <a property="homepage" href="http://example.com/gregg/" typeof="Person"><span property="name">Gregg</span></a>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://xmlns.com/foaf/0.1/'),
            quad('http://example.com/gregg/', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://xmlns.com/foaf/0.1/Person'),
            quad('http://example.com/gregg/#me', 'http://xmlns.com/foaf/0.1/homepage', 'http://example.com/gregg/'),
            quad('http://example.com/gregg/', 'http://xmlns.com/foaf/0.1/name', '"Gregg"'),
          ]);
      });
...
<body about="http://www.example.org/">
  <a href="http://www.example.org/license.xhtml" property="xhv:license" resource="[]">The Foo Document</a>
          ...
          .toBeRdfIsomorphic([
            quad('http://www.example.org/', 'http://www.w3.org/1999/xhtml/vocab#license', 'http://www.example.org/license.xhtml'),
          ]);
      });
  ...
  <div vocab="http://schema.org/" resource="http://example.org/base">
    <div resource="http://greggkellogg.net/#me">
      <p property="name" rel="homepage foaf:homepage" href="http://greggkellogg.net/">Gregg Kellogg</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/ns/rdfa#usesVocabulary', 'http://schema.org/'),
            quad('http://greggkellogg.net/#me', 'http://schema.org/name', '"Gregg Kellogg"'),
            quad('http://greggkellogg.net/#me', 'http://xmlns.com/foaf/0.1/homepage', 'http://greggkellogg.net/'),
          ]);
      });
...
xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="400" y="100" width="400" height="200"
        fill="yellow" stroke="navy" stroke-width="10"  />
          ...
          .toBeRdfIsomorphic([
            quad('http://example.com/', 'http://purl.org/dc/terms/description', '"A yellow rectangle with sharp corners."'),
          ]);
      });
...
xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="400" y="100" width="400" height="200"
        fill="yellow" stroke="navy" stroke-width="10"  />
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://purl.org/dc/terms/description', '"A yellow rectangle with sharp corners."'),
          ]);
      });
...
<body prefix="pr: relative/iri#" xmlns:xpr="relative/uri#">
  <p property="pr:prop xpr:prop">value</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://example.org/relative/iri#prop', '"value"'),
            quad('http://example.org/', 'http://example.org/relative/uri#prop', '"value"'),
          ]);
      });
...
<body prefix="pr: relative/iri#" xmlns:xpr="relative/uri#">
  <p property="pr:prop xpr:prop">value</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.com/', 'http://example.org/relative/iri#prop', '"value"'),
            quad('http://example.com/', 'http://example.org/relative/uri#prop', '"value"'),
          ]);
      });
...
<body>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#first', 'http://example.org/test.css'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#last', 'http://example.org/test.css'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#next', 'http://example.org/test.css'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#prev', 'http://example.org/test.css'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#subsection', 'http://example.org/test.css'),
          ]);
      });
...
<body>
  <div>
    ...
    <span property="cite">cite</span>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#alternate', '"alternate"'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#appendix', '"appendix"'),
            quad('http://example.org/', 'http://www.w3.org/1999/xhtml/vocab#cite', '"cite"'),
          ]);
      });
...
<body>
  ...
  <div id="heading1" role="heading">
      <p>Some contents that are a header</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#heading1', 'http://www.w3.org/1999/xhtml/vocab#role', 'http://www.w3.org/1999/xhtml/vocab#heading'),
          ]);
      });
  ...
  <div role="heading">
      <p>Some contents that are a header</p>
          ...
          .toBeRdfIsomorphic([
            quad('_:b', 'http://www.w3.org/1999/xhtml/vocab#role', 'http://www.w3.org/1999/xhtml/vocab#heading'),
          ]);
      });
  ...
  <div id="heading1" role="heading1 heading2">
      <p>Some contents that are a header</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#heading1', 'http://www.w3.org/1999/xhtml/vocab#role', 'http://www.w3.org/1999/xhtml/vocab#heading1'),
            quad('http://example.org/#heading1', 'http://www.w3.org/1999/xhtml/vocab#role', 'http://www.w3.org/1999/xhtml/vocab#heading2'),
          ]);
      });
  ...
  <div id="heading1" role="http://ex.org/heading">
      <p>Some contents that are a header</p>
          ...
          .toBeRdfIsomorphic([
            quad('http://example.org/#heading1', 'http://www.w3.org/1999/xhtml/vocab#role', 'http://ex.org/heading'),
          ]);
      });
    });
  });
